...
enum LiteralDescription: Equatable, Codable {
    ...
    ///
    /// For example `42.0`.
    case float(Float, precision: Int = 1)
...
indirect enum Declaration: Equatable, Codable {
    ...
    /// A declaration that adds an `@available` attribute for the provided declaration.
    case availableAttribute(AvailableAttributeDescription, Declaration)
...
/// A description of an available attribute.
///
/// For example: `@available(iOS 13.0, *)` or `@available(*, deprecated, message: "This is going away", renamed: "other(param:)")`
enum AvailableAttributeDescription: Equatable, Codable {
    /// A description of an OS availability attribute.
    ///
    /// For example: `@available(iOS 13.0, *)`
    struct SupportedPlatform : Equatable, Codable {
        var platformName: IdentifierDescription
        
        var version: IdentifierDescription
        
        init(platformName: String, version: String) {
            self.platformName = .pattern(platformName)
        ...
        static func macOS(_ versionString: String) -> SupportedPlatform { .init(platformName: "macOS", version: versionString) }
        ...
        /// - Returns: A `SupportedPlatform` instance.
        static func macCatalyst(_ versionString: String) -> SupportedPlatform { .init(platformName: "macCatalyst", version: versionString) }
        ...
        /// - Returns: A `SupportedPlatform` instance.
        static func iOS(_ versionString: String) -> SupportedPlatform { .init(platformName: "iOS", version: versionString) }
        ...
        /// - Returns: A `SupportedPlatform` instance.
        static func tvOS(_ versionString: String) -> SupportedPlatform { .init(platformName: "tvOS", version: versionString) }
        ...
        /// - Returns: A `SupportedPlatform` instance.
        static func watchOS(_ versionString: String) -> SupportedPlatform { .init(platformName: "watchOS", version: versionString) }
        ...
        ///
        /// - Parameter versionString: The minimum deployment target as a string representation of two or three dot-separated integers, such as `1.0.0`.
        /// - Returns: A `SupportedPlatform` instance.
        static func visionOS(_ versionString: String) -> SupportedPlatform  { .init(platformName: "visionOS", version: versionString) }
        ...
        /// - Returns: A `SupportedPlatform` instance.
        public static func custom(_ platformName: String, versionString: String) -> SupportedPlatform { .init(platformName: platformName, version: versionString) }
    }
    
    case os([SupportedPlatform])
    
    static func os(_ supportedPlatform: SupportedPlatform) -> Self {
    ...
    case deprecated(DeprecationDescription)
    
    static func deprecated(message: String?, renamed: String? = nil) -> Self {
        .deprecated(DeprecationDescription(message: message, renamed: renamed))
    }
}
...
extension Expression {
    ...
    ///
    /// For example `42.0`.
    /// - Parameter value: The float value of the literal.
    /// - Returns: A new `Expression` representing a float literal.
    static func literal(_ value: Float, precision: Int = 1) -> Self { .literal(.float(value, precision: precision)) }
...
extension Declaration {
    func available(_ supportedPlatforms: AvailableAttributeDescription.SupportedPlatform...) -> Self {
        .availableAttribute(.os(supportedPlatforms), self)
    }
    ...
    func deprecate(if description: AvailableAttributeDescription.DeprecationDescription?) -> Self {
        if let description { return .availableAttribute(.deprecated(description), self) }
        return self
    }

    /// Returns a new deprecated variant of the declaration if `shouldDeprecate` is true.
    func deprecate(if shouldDeprecate: Bool, description: @autoclosure () -> AvailableAttributeDescription.DeprecationDescription = .init()) -> Self {
        if shouldDeprecate { return .availableAttribute(.deprecated(description()), self) }
        return self
    }
...
extension Declaration {
    ...
    var accessModifier: AccessModifier? {
        get {
            ...
            case .availableAttribute(_, let declaration): return declaration.accessModifier
        ...
        set {
            ...
            case .availableAttribute(let attributeDescription, var declaration):
                declaration.accessModifier = newValue
                self = .availableAttribute(attributeDescription, declaration)
